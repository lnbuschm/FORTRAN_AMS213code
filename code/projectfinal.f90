...
program projectfinal
	...
	integer, parameter :: bigI = 32  ! Input parameter: mesh size bigI
	integer, parameter :: bigJ = 32  ! Input parameter: mesh size bigJ
	integer, parameter :: nOutputFiles = 10  ! Input parameter:  # of output files
	...
	! ********* USER INPUTS **********
	D = 1.0 ! 0.1 !0.01    ! Diffusion coefficient D:  Higher value = more/faster diffusion
	t0 = 0.0  ! Initial time t0
	tf = 1.0  ! Final time tf
	dt = 0.00001  ! Timestep dt ! 0.00001
	! ********* END USER INPUTS **********
	
	write(*,*) '******** FINAL PROJECT  --  AMS213 ******** '
	write(*,*) 'PDE Solvers:  Enter 1 for QUESTION 2: Crank Nicolson, 2 for QUESTION 2: FTCS, '
